...
class DeliveryFormDetailsWidget extends SalesdocketConsumerWidget {
  const DeliveryFormDetailsWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final lead = ref.watch(deliveryLeadRequestProvider);
    final detailItems = lead?.deliveryDetails ?? [];

    return SalesdocketDetailsCardWidget(
      label: LocaleKeys.deliveryDetails.tr(),
      items: detailItems,
    );
  }
}
