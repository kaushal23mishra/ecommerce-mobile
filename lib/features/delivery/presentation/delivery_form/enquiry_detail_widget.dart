...
class EnquiryDetailWidget extends SalesdocketConsumerWidget {
  const EnquiryDetailWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final lead = ref.watch(deliveryLeadRequestProvider);
    final detailItems = lead?.enquiryDetail ?? [];

    return SalesdocketDetailsCardWidget(
      label: LocaleKeys.enquiryDetail.tr(),
      items: detailItems,
    );
  }
}
