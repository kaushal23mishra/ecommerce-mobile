...
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/add_images_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/house_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/insurance_validity_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/interested_in_exchange_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/make_year_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/other_details_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/ownership_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/price_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/tyre_replacement_widget.dart';
import 'package:salesdocket_mobile/features/delivery/presentation/exchange_details/vehicle_details_widget.dart';
...
import 'delivery_date_of_evaluation_widget.dart';
  ...
  Widget _buildExchangeDetailsWidget(
    ...
    return Column(
      ...
      children: [
        ...
        const PriceWidget(),
        verticalSpacing(2.h),
        if (shouldShowDate) const DeliveryDateOfEvaluationWidget(),
        verticalSpacing(2.h),
