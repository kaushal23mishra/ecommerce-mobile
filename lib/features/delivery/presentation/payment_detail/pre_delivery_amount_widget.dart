...
class PreDeliveryAmountWidget extends SalesdocketConsumerWidget {
  const PreDeliveryAmountWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final receipts = ref
        .watch(deliveryReceiptsProvider)
        .filteredReceipts(type: ReceiptType.preDelivery);
