...
class _BookingActionState extends SalesdocketConsumerState<BookingActionWidget>
  ...
  void _sendExchangeData() {
    ...
    if (newExchangeProduct?.id != null) {
      final request = newExchangeProduct?.bookingUpdateExchangeDetailsRequest(
        lead: lead,
        newFirstTimeBuyer: newFirstTimeBuyer,
        newExchangeHouseDetails: newExchangeHouseDetails,
      );
      ...
      final request = newExchangeProduct?.bookingCreateExchangeDetailsRequest(
        lead: lead,
        newFirstTimeBuyer: newFirstTimeBuyer,
        newExchangeHouseDetails: newExchangeHouseDetails,
      );
  ...
  void _updateLead() {
    final lead = ref.read(bookingLeadRequestProvider);
    final request = lead?.bookingExchangeDetailsRequest();
