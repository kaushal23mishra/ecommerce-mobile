...
class TypeOfCustomersWidget extends SalesdocketConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final customerType = ref.watch(
      bookingLeadRequestProvider.select((state) => state?.customerType),
    );
    final error = ref
  ...
  Widget _corporateNameWidget(BuildContext context, WidgetRef ref) {
    ...
    final corporateName = ref.watch(
      bookingLeadRequestProvider.select((state) => state?.corporateName),
    );
    final error = ref
        .watch(bookingFormErrorsProvider)
    ...
    return customerType == CustomerType.corporate.value
        ? Padding(
          ...
          child: SalesDocketInputWidget(
            ...
            hint: "${LocaleKeys.lblCorporate.tr()} Name",
            onChanged: (value) {
              ref
                  .read(bookingLeadRequestProvider.notifier)
                  .update(
